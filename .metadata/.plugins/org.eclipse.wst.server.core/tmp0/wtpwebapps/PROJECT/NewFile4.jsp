...
<img align=left src="D:\v1.jpg" width="650" height="120" style="float:left; padding:4px 8px 5px 5px; border-radius: 3px;" > 
...
<h3 align="justify" class="roboto-slab text-center">Principal's Message</h3>
       ...
       <p class="director-hdr"><img src="C:\Users\Lenovo\eclipse-workspace\PROJECT\WebContent\female.png" width="150" height="120" style="float: left; padding:4px 8px 5px 5px; border-radius: 3px;" /></p>
