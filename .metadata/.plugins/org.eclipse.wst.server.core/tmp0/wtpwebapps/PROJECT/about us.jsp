...
<br><font size="5" align="left" color="red">Academy management:-</font>
<body>
<br>The overall management of the institute is vested with the state government of the state Government.<br>However,at the institute,the principal is responsible for day-to-day administration.<br>Odisha Higher education Department introduces e-admission system at +3 level in 53 Degree colleges from the academic session 2010-11 and all the degree colleges across the state of Odisha for the first time from the last year e-admission under SAMS.<br> The system would begin on the same date when the result of +2 examinations will be published. 
</body>
<br>
<font align="left" color="red" size="5">Contact us:-</font>
<body>
<br>Vidyarthi University,<br>
Pravati lane,<br>
Dutta tota,<br>
Puri,<br>
Odisha<br>
Pin code:752001<br>
Mob no.-+91xxxxxxxxxx<br>
Email Id:vidyarthi@gmail.com
</body>
<br><font align="left" color="red" size="5">Academics:-</font>
<body>
<br><a href="#"style="color: black;text-decoration: none;"> Courses</a><br>
<a href="#"style="color: black;text-decoration: none;"> syllabus</a><br>
<a href="#"style="color: black;text-decoration: none;"> faculty</a><br>
<a href="#"style="color: black;text-decoration: none;"> academic Achivements</a><br>
<a href="#"style="color: black;text-decoration: none;">fees</a><br>
<a href="#"style="color: black;text-decoration: none;">Awards</a>
</body>
<br><font size="5" color="red">College History:-</font>
<body>
 <br>Vidyarthi University, Puri, is one of the premier institutions of the state devoted to the cause of higher education. Situated in the holy city of Puri this citadel of learning had its modest inception as Puri College in the year 1990, which initially functioned in the building of MIT. Gradually in a span of five years this college became one of the most prestigious institutions of the state attracting a large number of students from all over the state, because of high standard of teaching-learning package offered by the teaching faculty. Needless to say that the picturesque landscape of Puri lapped by the Bay of Bengal and nestled by lush green cocoanut, cashew and casuarinas groves lend this college the most serene and tranquil environment so conducive to any meaningful scholastic pursuits. Within that short span of time the academic performance of this college became so conspicuous that students from far and wide sought admission into this college and in response to the growing demand of the students this college was shifted to its own building, an 'E' shaped redbrick massive structure that in itself stands as an architectural monument, the 'E' signifying Enlightenment.Now-a-days this institute is one of the best university in Odisha.
</body>
</font>
<br>

<body>
  About us|Feedback|Notice|Sitemap<br>
  copyright &copy 2019 Vidyarthi University:Allrights reserved<br>
</body>
<body>
  Follow us:
</body>
  <meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <i class="fab fa-facebook fa-lg"style="font-size:20px;color:blue"></i>
      <i class="fab fa-twitter"style="font-size:20px;color:blue"></i>
      <i class="fab fa-instagram"style="font-size:20px;color:hotpink"></i>
