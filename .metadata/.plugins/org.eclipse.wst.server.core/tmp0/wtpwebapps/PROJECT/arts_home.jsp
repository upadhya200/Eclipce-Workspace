...
<div class="article">
             ...
             <ul class="ulfont">
                 <li><a  href="eng.jsp" >English</a></li>
                 <li><a href="history.jsp" >History</a></li>
                
                 
                 <li><a  href="pol.jsp" >Political Science</a></li>
                 
                 <li><a  href="sanskrit.jsp" >Sanskrit</a></li>
                
                 <li><a  href="eco.jsp">Economics</a></li>
                 <li><a  href="edu.jsp">Education</a></li>
                 <li><a  href="hindi.jsp" >Hindi</a></li>
                 <li><a  href="philosophy.jsp" >Philosophy</a></li>
                 <li><a  href="psy.jsp" >Psychology</a></li>
