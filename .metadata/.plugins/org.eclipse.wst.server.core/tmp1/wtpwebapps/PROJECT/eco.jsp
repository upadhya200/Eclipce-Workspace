...
<h1>Welcome,Department Of Economics</h1></div>
<body background="C:\Users\SNEHA PATRA\eclipse-workspace\Sneha\q2.jpg">
<img src="C:\Users\SNEHA PATRA\eclipse-workspace\Sneha\p60.png" height="300px" width="400px" style="margin-left: 500px;">
<tr>
 
 <div style="padding-left: 20px"> 
<th><h2>About Department</h2><th></div>
  <ul>
Vidyarthi University,Puri,Odisha, has long been recognized as a premier institution of higher learning  in IndiaOne of the most sought after
 courses, an Honours in Economics is highly reputed and well recognised in the University. It introduces students to the basics of
  Microeconomics, Macroeconomics, quantitative techniques and other specialised areas like Public Finance, International Trade, Money and 
  Financial Markets, and Indian Economy. The department is credited with highly dynamic and meritorious group of faculty, along with a vibrant
   and active student council, which regularly organizes seminars, lectures etc, giving ample opportunity to students to contribute positively
    to the department. Graduates can pursue a Masters course in the subject or opt for direct placement in several corporate and governmental
     organisations.</ul>
<tr>
