...
<h1>Welcome,Department Of Education</h1></div>
<body background="C:\Users\Lenovo\eclipse-workspace\PROJECT\WebContent\q2.jpg">
<img src="C:\Users\Lenovo\eclipse-workspace\PROJECT\WebContent\p59.jpg" height="300px" width="400px" style="margin-left: 500px;">
<tr>
 
 <div style="padding-left: 20px"> 
<th><h2>About Department</h2><th></div>
  <ul>
Vidyarthi University,Puri,Odisha, has long been recognized as a premier institution of higher learning  in India. A centre for academic excellence and 
achievement, it is today one of the finest institutions for Social Sciences, Humanities and Commerce, while also offering a B.Sc. Programme in Statistics. 
Professional courses like Elementary Education and Journalism are among its strengths. Located at the cutting edge of knowledge, University has not just
 kept pace with the changing world, but has been the pioneering spirit behind many innovations in the field of education. The striving is to imbue the
  teaching/learning process with a unique blend of intellectual rigour and aesthetic and ethical engagement.</ul>
<tr>
