...
<div class="dropdown1">
  ...
  <a href="C:\Users\Lenovo\eclipse-workspace\PROJECT\WebContent\WebContent\philosophy_gallery.jsp">Gallery</a>
  <a href="C:\Users\Lenovo\eclipse-workspace\PROJECT\WebContent\WebContent\philosophy_achievement.jsp">Achievements</a>
</div>
</body>
</html>
...
<h1>Welcome,Department Of Philosophy</h1></div>
<body background="C:\Users\Lenovo\eclipse-workspace\PROJECT\WebContent\q2.jpg">
<img src="C:\Users\Lenovo\eclipse-workspace\PROJECT\WebContent\p64.png" height="300px" width="400px" style="margin-left: 500px;">
<tr>
 
 <div style="padding-left: 20px"> 
<th><h2>About Department</h2><th></div>
  <ul>
Vidyarthi University,Puri,Odisha, has long been recognized as a premier institution of higher learning  in India.The Department offers Philosophy as a main subject in B.A. Programme and courses in lieu of Hindi (MIL). For other Honours students the Department offers four Generic Elective courses. The courses cover important milestone in the development of Logic, Ethics, Indian Philosophy, Western Philosophy, Greek Philosophy, Philosophy of Religion, Socio-Political Philosophy and Feminism among many. Students can be benefitted from the rigor of the subject and develop intellectual potential and high analytical ability. Some of the possible avenues that can be explored on the basis of this initiation in the subject are M.A. in Philosophy, Entrepreneurship, Civil Services and other related competitive exams.</ul>
<tr>
