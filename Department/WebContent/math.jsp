...
<h1>Welcome,Department Of Mathematics</h1></div>
<body background="C:\Users\Lenovo\eclipse-workspace\q2.jpg">
<img src="C:\Users\Lenovo\eclipse-workspace\p67.png" height="300px" width="400px" style="margin-left: 500px;">
<tr>
 
 <div style="padding-left: 20px"> 
<th><h2>About Department</h2><th></div>
  <ul>
Vidyarthi University,Puri,Odisha, has long been recognized as a premier institution of higher learning  in India.The students pursuing the course, B.Sc.(Hons) Mathematics offered by the department, can look forward for the development of their logical ability and analytic skills. The semester based syllabi provides a comprehensive survey of areas like analysis, algebra, mathematical modelling using differential equations, mathematical programming and statistics. A lot of emphasis is given to 'hands-on' exposure to modern software such as Mathematica, Matlab and LaTeX through practical. The Mathematics Society 'Pi' organizes seminars, quizzes, discussions and talks on regular basis for exploration beyond the prescribed syllabi. The students actively participate in other co-curricular activities in the College for their holistic development. Students graduating from the department have had a world of career options. </ul>
<tr>
