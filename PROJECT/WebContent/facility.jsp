...
: The physical infrastructure consists of the "E" shaped main building of the college where the teaching departments, one central library, the administrative block and four lecture theatres including a magnificent Hall provide enough space for class, conference and seminars.
</br></br>:Laboratories
</br>
 </br>:Information Bureau
</br> </br>:Common Room
</br></br>:Basic facilities
 </br></br>:Playground and Gymnasium
 </br></br>:Accommodation / Hostel facility
</br> </br>:Other Health Care Services
</br></br>: Canteen
</br> </br>:POST OFFICE & BANK
</br> </br>:Library
</br></br> :The college has provision for NCC(Men/Women, Army wing) and NSS( Boys & Girls).
</br></br> :In accordance with the orders of the Hon�ble Supreme Court of India, an Anti-Ragging Cell has been formed in the college.
</br></br> :There is an Information Dissemination Cell (Under Right to Information Act) which is meant to disseminate relevant information to any one on matters relating to the college.
